    ...
    return (
        <section>
            <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] font-bold tracking-widest text-blue-500 uppercase">Descrição e Comprovantes</span>
            </div>
            <div className="bg-gray-50/60 rounded-xl border border-gray-100 p-4">
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Descrição Detalhada</label>
                        <textarea
                            value={description}
